...
public class Camera_test extends Activity implements CvCameraViewListener2 {
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        switch (Camera_test.viewMode) {
            case Camera_test.VIEW_MODE_RGBA:
                break;

            case Camera_test.VIEW_MODE_HIST:
                Mat hist = new Mat();
            ...
            case Camera_test.VIEW_MODE_CANNY:
            ...
            case Camera_test.VIEW_MODE_SOBEL:
            ...
            case Camera_test.VIEW_MODE_SEPIA:
                rgbaInnerWindow = rgba.submat(top, top + height, left, left + width);
                Core.transform(rgbaInnerWindow, rgbaInnerWindow, mSepiaKernel);
                rgbaInnerWindow.release();
                break;

            case Camera_test.VIEW_MODE_ZOOM:
            ...
            case Camera_test.VIEW_MODE_PIXELIZE:
                rgbaInnerWindow = rgba.submat(top, top + height, left, left + width);
            ...
            case Camera_test.VIEW_MODE_POSTERIZE:
            /*
